      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-16 text-center animate-fade-in">
          <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-8 border border-white/30 hover:bg-white/30 transition-all duration-300">
            <div className="flex items-center justify-center mb-4">
              ...
              <h3 className="text-2xl font-bold text-gray-900">View All Certifications</h3>
            </div>
            ...
            <a
              ...
              className="inline-flex items-center space-x-2 px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all duration-300 hover:scale-105"
            >
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 border border-white/30 text-center hover:bg-white/30 transition-all duration-300 hover:scale-105">
            ...
            <div className="text-gray-700 font-medium">Latest Year</div>
          </div>
        </div>
      </div>
    </section>
