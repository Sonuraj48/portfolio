    ...
    <section id="resume" className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-8 border border-white/30 mb-12 hover:bg-white/30 transition-all duration-500 hover:scale-105 hover:shadow-2xl animate-slide-up">
          <div className="flex flex-col lg:flex-row items-center space-y-6 lg:space-y-0 lg:space-x-8">
            ...
            <div className="flex-shrink-0">
              <div className="w-48 h-64 bg-white rounded-lg shadow-lg border border-gray-200 relative overflow-hidden group">
                {/* Mock resume content */}
            ...
            <div className="flex-1 text-center lg:text-left">
              <h3 className="text-3xl font-bold text-gray-900 mb-4">Professional Resume</h3>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                ...
                <button
                  ...
                  className="group inline-flex items-center space-x-2 px-6 py-3 bg-white/30 backdrop-blur-sm text-gray-800 border border-white/30 rounded-lg hover:bg-white/40 transition-all duration-300 hover:scale-105"
                >
                  <Eye size={20} className="group-hover:scale-110 transition-transform duration-300" />
                  <span className="font-medium">View Online</span>
                </button>
              </div>
        ...
        <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-8 border border-white/30 animate-slide-up" style={{ animationDelay: '0.4s' }}>
          <h4 className="text-2xl font-bold text-gray-900 mb-6 text-center">What's Inside My Resume</h4>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700">Focused on AI/ML and DevOps engineering</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700">Programming, databases, DevOps tools</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-2 h-2 bg-purple-500 rounded-full mt-2 flex-shrink-0"></div>
                <div>
                  <h5 className="font-semibold text-gray-900">Project Portfolio</h5>
                  <p className="text-sm text-gray-700">Detailed project descriptions and achievements</p>
                </div>
              </div>
            </div>
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700">DevOps internship and achievements</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700">Academic background and achievements</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-2 h-2 bg-teal-500 rounded-full mt-2 flex-shrink-0"></div>
                <div>
                  <h5 className="font-semibold text-gray-900">Certifications</h5>
                  <p className="text-sm text-gray-700">Professional certifications and credentials</p>
                </div>
              </div>
            </div>
          </div>
