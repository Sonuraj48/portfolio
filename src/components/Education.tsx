    ...
    <section id="education" className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
            ...
            {educationData.map((education, index) => (
              ...
              >
                ...
                <div className={`flex-1 max-w-2xl ${index % 2 === 0 ? 'md:mr-8' : 'md:ml-8'}`}>
                  <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-8 border border-white/30 hover:bg-white/30 transition-all duration-500 hover:scale-105 hover:shadow-xl">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center space-x-2 text-gray-600">
                        <Calendar className="w-4 h-4" />
                        <span className="text-sm font-medium">{education.duration}</span>
                      </div>
                      <div className={`px-4 py-2 bg-gradient-to-r ${education.gradient} text-white rounded-full text-sm font-bold`}>
                        {education.grade}
                      </div>
                    </div>

                    <h3 className="text-2xl font-bold text-gray-900 mb-2">{education.degree}</h3>
                    <h4 className="text-lg font-semibold text-blue-700 mb-4">{education.institution}</h4>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 border border-white/30 text-center hover:bg-white/30 transition-all duration-300 hover:scale-105">
          ...
          <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 border border-white/30 text-center hover:bg-white/30 transition-all duration-300 hover:scale-105">
            ...
            <div className="text-gray-700 font-medium">Hackathons Participated</div>
          </div>
          <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 border border-white/30 text-center hover:bg-white/30 transition-all duration-300 hover:scale-105">
