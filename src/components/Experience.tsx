      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative">
          ...
          <div className="relative flex items-start space-x-8 animate-slide-up">
            ...
            {/* Experience content */}
            <div className="flex-1 bg-white/20 backdrop-blur-sm rounded-2xl p-8 border border-white/30 hover:bg-white/30 transition-all duration-500 hover:scale-105 hover:shadow-xl">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
                <div>
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">DevOps Intern</h3>
                  <h4 className="text-lg font-semibold text-blue-700 mb-2">LinuxWorld Informatics Pvt Ltd</h4>
                </div>
              ...
              <div className="mb-6">
                <h5 className="text-lg font-semibold text-gray-900 mb-3">Key Responsibilities & Achievements:</h5>
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {['Docker', 'Jenkins', 'Kubernetes', 'CI/CD', 'Linux', 'DevOps'].map((tech) => (
                  <span
                    key={tech}
                    className="px-3 py-1 bg-white/30 backdrop-blur-sm rounded-full text-sm font-medium text-gray-800 border border-white/20"
                  >
                    {tech}
                  </span>
                ))}
